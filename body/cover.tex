%===============  封面  =================
\newcommand{\xihei}{\CJKfontspec{STXihei}}
...
\vspace*{2.2cm}
\xihei{\zihao{2} 沈阳建筑大学本科毕业设计（论文）题目 }\\
\heiti{\zihao{3} \textbf{The Subject of Undergraduate Graduation Project (Thesis) of DUT} }\\}
\vspace*{3.5cm}
